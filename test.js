...
require('./js/engine.js');['sports1','sports2','classics1','classics2','threed','puzzle','threed2','solo','sports3','versus2','puzzle2','classics3','threed3','action','cards','sim','threed4'].forEach(f=>require('./games/'+f+'.js'));
